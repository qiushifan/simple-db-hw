...
public class TupleDesc implements Serializable {
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        ...
        for (int i = 0; i < td1.tdItemList.size(); i++) {
            resType[i] = td1.tdItemList.get(i).fieldType;
            resName[i] = td1.tdItemList.get(i).fieldName;
        }
        for (int j = td1.numFields(); j < size; j++) {
            resType[j] = td2.tdItemList.get(j - td1.numFields()).fieldType;
            resName[j] = td2.tdItemList.get(j - td1.numFields()).fieldName;
        }

        return new TupleDesc(resType, resName);
    }
